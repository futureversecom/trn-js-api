...
import type { Call, H160, H256, H512, PerU16, Perbill, Percent, Permill } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletAssetsExtEvent extends Enum {
    ...
    readonly type: 'PlaceHold' | 'ReleaseHold' | 'SpendHold' | 'SplitTransfer' | 'CreateAsset' | 'InternalWithdraw' | 'InternalDeposit';
  }
  ...
  interface PalletStakingPalletEvent extends Enum {
    ...
    readonly asRewarded: ITuple<[SeedPrimitivesSignatureAccountId20, u128]>;
    readonly isSlashed: boolean;
    readonly asSlashed: ITuple<[SeedPrimitivesSignatureAccountId20, u128]>;
    readonly isOldSlashingReportDiscarded: boolean;
    readonly asOldSlashingReportDiscarded: u32;
    readonly isStakersElected: boolean;
    readonly isBonded: boolean;
    readonly asBonded: ITuple<[SeedPrimitivesSignatureAccountId20, u128]>;
    readonly isUnbonded: boolean;
    readonly asUnbonded: ITuple<[SeedPrimitivesSignatureAccountId20, u128]>;
    readonly isWithdrawn: boolean;
    readonly asWithdrawn: ITuple<[SeedPrimitivesSignatureAccountId20, u128]>;
    readonly isKicked: boolean;
    readonly asKicked: ITuple<[SeedPrimitivesSignatureAccountId20, SeedPrimitivesSignatureAccountId20]>;
    readonly isStakingElectionFailed: boolean;
    readonly isChilled: boolean;
    readonly asChilled: SeedPrimitivesSignatureAccountId20;
    readonly isPayoutStarted: boolean;
    readonly asPayoutStarted: ITuple<[u32, SeedPrimitivesSignatureAccountId20]>;
    readonly isValidatorPrefsSet: boolean;
    readonly asValidatorPrefsSet: ITuple<[SeedPrimitivesSignatureAccountId20, PalletStakingValidatorPrefs]>;
  ...
  /** @name SpFinalityGrandpaAppPublic (54) */
  ...
  /** @name PalletTransactionPaymentEvent (67) */
  ...
  interface PalletDexEvent extends Enum {
    ...
    readonly asAddLiquidity: ITuple<[SeedPrimitivesSignatureAccountId20, u32, u128, u32, u128, u128]>;
    readonly isRemoveLiquidity: boolean;
    readonly asRemoveLiquidity: ITuple<[SeedPrimitivesSignatureAccountId20, u32, u128, u32, u128, u128]>;
    readonly isSwap: boolean;
    readonly asSwap: ITuple<[SeedPrimitivesSignatureAccountId20, Vec<u32>, u128, u128]>;
    ...
    readonly type: 'AddProvision' | 'AddLiquidity' | 'RemoveLiquidity' | 'Swap' | 'EnableTradingPair' | 'DisableTradingPair' | 'ProvisioningToEnabled';
  }

  /** @name PalletDexTradingPair (70) */
  interface PalletDexTradingPair extends ITuple<[u32, u32]> {}

  /** @name PalletNftEvent (71) */
  interface PalletNftEvent extends Enum {
    ...
    readonly asCollectionCreate: {
      ...
      readonly name: Bytes;
      readonly royaltiesSchedule: Option<PalletNftRoyaltiesSchedule>;
      readonly originChain: PalletNftOriginChain;
    ...
    readonly asFixedPriceSaleClose: {
      ...
      readonly serialNumbers: Vec<u32>;
      readonly listingId: u128;
      readonly reason: PalletNftFixedPriceClosureReason;
    } & Struct;
    ...
    readonly asAuctionClose: {
      readonly collectionId: u32;
      readonly listingId: u128;
      readonly reason: PalletNftAuctionClosureReason;
    } & Struct;
    ...
    readonly type: 'CollectionCreate' | 'Mint' | 'BridgedMint' | 'OwnerSet' | 'MaxIssuanceSet' | 'BaseUriSet' | 'Transfer' | 'Burn' | 'FixedPriceSaleList' | 'FixedPriceSaleComplete' | 'FixedPriceSaleClose' | 'FixedPriceSalePriceUpdate' | 'AuctionOpen' | 'AuctionSold' | 'AuctionClose' | 'Bid' | 'MarketplaceRegister' | 'Offer' | 'OfferCancel' | 'OfferAccept' | 'CollectionClaimed';
  }

  /** @name PalletNftRoyaltiesSchedule (76) */
  interface PalletNftRoyaltiesSchedule extends Struct {
    readonly entitlements: Vec<ITuple<[SeedPrimitivesSignatureAccountId20, Permill]>>;
  }

  /** @name PalletNftOriginChain (80) */
  interface PalletNftOriginChain extends Enum {
    readonly isEthereum: boolean;
    readonly isRoot: boolean;
    readonly type: 'Ethereum' | 'Root';
  }

  /** @name PalletNftCrossChainCompatibility (81) */
  interface PalletNftCrossChainCompatibility extends Struct {
    readonly xrpl: bool;
  }

  /** @name PalletNftFixedPriceClosureReason (83) */
  interface PalletNftFixedPriceClosureReason extends Enum {
    readonly isVendorCancelled: boolean;
    readonly isExpired: boolean;
    readonly type: 'VendorCancelled' | 'Expired';
  }

  /** @name PalletNftAuctionClosureReason (84) */
  interface PalletNftAuctionClosureReason extends Enum {
  ...
  interface PalletXrplBridgeEvent extends Enum {
    ...
    readonly type: 'TransactionAdded' | 'TransactionChallenge' | 'ProcessingOk' | 'ProcessingFailed' | 'NotSupportedTransaction' | 'WithdrawRequest' | 'RelayerAdded' | 'RelayerRemoved' | 'DoorAddressSet' | 'DoorNextTicketSequenceParamSet' | 'DoorTicketSequenceParamSet' | 'TicketSequenceThresholdReached';
  }

  /** @name PalletEchoEvent (89) */
  ...
  /** @name PalletElectionProviderMultiPhaseEvent (90) */
  ...
  /** @name PalletElectionProviderMultiPhaseElectionCompute (91) */
  ...
  interface PalletEthyRawEvent extends Enum {
    ...
    readonly type: 'Verified' | 'Invalid' | 'AuthoritySetChange' | 'XrplAuthoritySetChange' | 'ProofDelayed' | 'ProcessingOk' | 'ProcessingFailed' | 'Challenged' | 'ProcessAtExtended' | 'EventSend' | 'EventSubmit' | 'RelayerBondDeposit' | 'RelayerBondWithdraw' | 'RelayerSet' | 'XrplDoorSignersSet' | 'FinaliseScheduleFail' | 'SetContractAddress' | 'XrplAuthoritySetChangeRequestFailed';
  }

  /** @name SeedPalletCommonEventRouterError (95) */
  ...
  /** @name PalletEthyEthySigningRequest (96) */
  ...
  /** @name PalletEthyEthereumEventInfo (97) */
  ...
  /** @name EvmCoreErrorExitReason (100) */
  ...
  /** @name EvmCoreErrorExitSucceed (101) */
  ...
  /** @name EvmCoreErrorExitError (102) */
  ...
  /** @name EvmCoreErrorExitRevert (105) */
  interface EvmCoreErrorExitRevert extends Enum {
    readonly isReverted: boolean;
    readonly type: 'Reverted';
  }

  /** @name EvmCoreErrorExitFatal (106) */
  ...
  /** @name PalletEvmChainIdEvent (110) */
  ...
  /** @name PalletErc20PegRawEvent (111) */
  interface PalletErc20PegRawEvent extends Enum {
    ...
    readonly type: 'Erc20DepositDelayed' | 'Erc20WithdrawalDelayed' | 'DelayedErc20DepositFailed' | 'DelayedErc20WithdrawalFailed' | 'Erc20Deposit' | 'Erc20Withdraw' | 'Erc20DepositFail' | 'SetContractAddress' | 'PaymentDelaySet' | 'NoAvailableDelayedPaymentIds';
  }

  /** @name PalletNftPegEvent (112) */
  interface PalletNftPegEvent extends Enum {
    ...
    readonly type: 'Erc721Deposit' | 'Erc721Mint' | 'Erc721Withdraw' | 'ContractAddressSet';
  }

  /** @name PalletFeeProxyEvent (118) */
  ...
  /** @name PalletFeeControlEvent (119) */
  type PalletFeeControlEvent = Null;

  /** @name PalletXls20Event (120) */
  interface PalletXls20Event extends Enum {
    ...
    readonly type: 'Xls20MintRequest' | 'RelayerSet' | 'Xls20MintFeeSet' | 'Xls20MappingSet' | 'Xls20CompatibilityEnabled' | 'Xls20MintFeePaid';
  }

  /** @name PalletProxyEvent (124) */
  interface PalletProxyEvent extends Enum {
    ...
    readonly asAnonymousCreated: {
      readonly anonymous: SeedPrimitivesSignatureAccountId20;
      readonly who: SeedPrimitivesSignatureAccountId20;
  ...
  /** @name SeedRuntimeImplsProxyType (125) */
  interface SeedRuntimeImplsProxyType extends Enum {
    ...
    readonly type: 'NoPermission' | 'Any' | 'NonTransfer' | 'Governance' | 'Staking';
  }

  /** @name PalletFuturepassEvent (127) */
  interface PalletFuturepassEvent extends Enum {
    ...
    readonly type: 'FuturepassCreated' | 'DelegateRegistered' | 'DelegateUnregistered' | 'FuturepassTransferred' | 'DefaultFuturepassSet' | 'ProxyExecuted' | 'FuturepassAssetsMigrated' | 'FuturepassMigratorSet';
  }
  ...
  /** @name FrameSupportWeightsPerDispatchClassWeightsPerClass (136) */
  ...
  /** @name SpConsensusBabeDigestsSecondaryPlainPreDigest (160) */
  interface SpConsensusBabeDigestsSecondaryPlainPreDigest extends Struct {
    readonly authorityIndex: u32;
    readonly slot: u64;
  }

  /** @name SpConsensusBabeDigestsSecondaryVRFPreDigest (161) */
  ...
  /** @name PalletSchedulerScheduledV3 (174) */
  ...
  /** @name FrameSupportScheduleMaybeHashed (175) */
  ...
  /** @name SeedRuntimeOriginCaller (181) */
  ...
  /** @name FrameSupportDispatchRawOrigin (182) */
  ...
  /** @name PalletEthereumRawOrigin (183) */
  ...
  /** @name PalletAssetsDestroyWitness (189) */
  ...
  /** @name PalletStakingPalletCall (194) */
  ...
  /** @name PalletStakingRewardDestination (195) */
  ...
  /** @name PalletStakingPalletConfigOpU128 (197) */
  ...
  /** @name PalletStakingPalletConfigOpU32 (198) */
  ...
  /** @name PalletStakingPalletConfigOpPercent (199) */
  ...
  /** @name PalletStakingPalletConfigOpPerbill (200) */
  ...
  /** @name SeedRuntimeSessionKeys (202) */
  ...
  /** @name SpFinalityGrandpaEquivocationProof (207) */
  interface SpFinalityGrandpaEquivocationProof extends Struct {
    readonly setId: u64;
    readonly equivocation: SpFinalityGrandpaEquivocation;
  }

  /** @name SpFinalityGrandpaEquivocation (208) */
  ...
  /** @name PalletImOnlineHeartbeat (218) */
  ...
  /** @name SpCoreOffchainOpaqueNetworkState (219) */
  interface SpCoreOffchainOpaqueNetworkState extends Struct {
    readonly peerId: OpaquePeerId;
    readonly externalAddresses: Vec<OpaqueMultiaddr>;
  }

  /** @name PalletImOnlineSr25519AppSr25519Signature (223) */
  ...
  interface PalletDexCall extends Enum {
    ...
    readonly asAddLiquidity: {
      readonly assetIdA: u32;
      readonly assetIdB: u32;
    ...
    readonly asRemoveLiquidity: {
      readonly assetIdA: u32;
      readonly assetIdB: u32;
      readonly removeLiquidity: Compact<u128>;
    ...
    readonly type: 'SwapWithExactSupply' | 'SwapWithExactTarget' | 'AddLiquidity' | 'RemoveLiquidity' | 'ReenableTradingPair' | 'DisableTradingPair';
  }

  /** @name PalletNftCall (227) */
  interface PalletNftCall extends Enum {
    ...
    readonly type: 'ClaimUnownedCollection' | 'SetOwner' | 'SetMaxIssuance' | 'SetBaseUri' | 'RegisterMarketplace' | 'CreateCollection' | 'Mint' | 'Transfer' | 'Burn' | 'Sell' | 'Buy' | 'Auction' | 'Bid' | 'CancelSale' | 'UpdateFixedPrice' | 'MakeSimpleOffer' | 'CancelOffer' | 'AcceptOffer';
  }

  /** @name PalletXrplBridgeCall (228) */
  interface PalletXrplBridgeCall extends Enum {
    ...
    readonly asSubmitTransaction: {
      ...
      readonly transaction: PalletXrplBridgeHelpersXrplTxData;
    ...
    readonly type: 'SubmitTransaction' | 'SubmitChallenge' | 'WithdrawXrp' | 'AddRelayer' | 'RemoveRelayer' | 'SetDoorTxFee' | 'SetDoorAddress' | 'SetTicketSequenceNextAllocation' | 'SetTicketSequenceCurrentAllocation';
  }

  /** @name PalletXrplBridgeHelpersXrplTxData (229) */
  interface PalletXrplBridgeHelpersXrplTxData extends Enum {
  ...
  /** @name PalletTokenApprovalsCall (230) */
  interface PalletTokenApprovalsCall extends Enum {
    ...
    readonly type: 'Erc721Approval' | 'Erc721RemoveApproval' | 'Erc20Approval' | 'Erc20UpdateApproval' | 'Erc721ApprovalForAll';
  }

  /** @name PalletEchoCall (231) */
  ...
  /** @name PalletMarketplaceCall (232) */
  interface PalletMarketplaceCall extends Enum {
    ...
    readonly type: 'RegisterMarketplace' | 'SellNft' | 'UpdateFixedPrice' | 'Buy' | 'AuctionNft' | 'Bid' | 'CancelSale' | 'MakeSimpleOffer' | 'CancelOffer' | 'AcceptOffer';
  }

  /** @name PalletElectionProviderMultiPhaseCall (233) */
  ...
  /** @name PalletElectionProviderMultiPhaseRawSolution (234) */
  ...
  /** @name SeedRuntimeNposCompactSolution16 (235) */
  ...
  /** @name SpNposElectionsElectionScore (286) */
  ...
  /** @name PalletElectionProviderMultiPhaseSolutionOrSnapshotSize (287) */
  interface PalletElectionProviderMultiPhaseSolutionOrSnapshotSize extends Struct {
    readonly voters: Compact<u32>;
    readonly targets: Compact<u32>;
  }

  /** @name SpNposElectionsSupport (291) */
  interface SpNposElectionsSupport extends Struct {
    readonly total: u128;
    readonly voters: Vec<ITuple<[SeedPrimitivesSignatureAccountId20, u128]>>;
  }

  /** @name PalletBagsListCall (292) */
  ...
  interface PalletEthyCall extends Enum {
    ...
    readonly type: 'SetXrplDoorSigners' | 'SetRelayer' | 'DepositRelayerBond' | 'WithdrawRelayerBond' | 'SetEventBlockConfirmations' | 'SetDelayedEventProofsPerBlock' | 'SetChallengePeriod' | 'SetContractAddress' | 'SetBridgePaused' | 'FinaliseAuthoritiesChange' | 'SubmitEvent' | 'SubmitChallenge' | 'SubmitNotarization';
  }
  ...
  interface PalletEthyCheckedEthCallResult extends Enum {
    ...
    readonly type: 'Ok' | 'ReturnDataExceedsLimit' | 'ReturnDataEmpty' | 'DataProviderErr' | 'InvalidEthBlock' | 'InvalidTimestamp';
  }
  ...
  interface PalletEthyEventClaimResult extends Enum {
    ...
    readonly type: 'Valid' | 'DataProviderErr' | 'TxStatusFailed' | 'UnexpectedContractAddress' | 'NoTxLogs' | 'NotEnoughConfirmations' | 'UnexpectedData' | 'NoTxReceipt' | 'UnexpectedSource';
  }
  ...
  /** @name EthereumTransactionTransactionV2 (302) */
  ...
  /** @name EthereumTransactionLegacyTransaction (303) */
  ...
  /** @name EthereumTransactionTransactionAction (306) */
  ...
  /** @name EthereumTransactionTransactionSignature (307) */
  ...
  /** @name EthereumTransactionEip2930Transaction (309) */
  ...
  /** @name EthereumTransactionAccessListItem (311) */
  interface EthereumTransactionAccessListItem extends Struct {
    readonly address: H160;
    readonly storageKeys: Vec<H256>;
  }

  /** @name EthereumTransactionEip1559Transaction (312) */
  ...
  interface PalletErc20PegCall extends Enum {
    ...
    readonly type: 'ActivateDeposits' | 'ActivateWithdrawals' | 'Withdraw' | 'SetContractAddress' | 'SetErc20Meta' | 'SetPaymentDelay';
  }

  /** @name PalletNftPegCall (321) */
  interface PalletNftPegCall extends Enum {
    ...
    readonly type: 'SetContractAddress' | 'Withdraw';
  }

  /** @name PalletFeeProxyCall (322) */
  ...
  interface PalletFeeControlCall extends Enum {
    ...
    readonly type: 'SetEvmBaseFee' | 'SetWeightMultiplier';
  }

  /** @name PalletXls20Call (324) */
  interface PalletXls20Call extends Enum {
    ...
    readonly type: 'SetRelayer' | 'SetXls20Fee' | 'EnableXls20Compatibility' | 'ReRequestXls20Mint' | 'FulfillXls20Mint';
  }

  /** @name PalletProxyCall (327) */
  ...
  /** @name PalletFuturepassCall (329) */
  interface PalletFuturepassCall extends Enum {
    readonly isCreate: boolean;
    readonly asCreate: {
      readonly account: SeedPrimitivesSignatureAccountId20;
    } & Struct;
    readonly isRegisterDelegate: boolean;
    readonly asRegisterDelegate: {
      readonly futurepass: SeedPrimitivesSignatureAccountId20;
      readonly delegate: SeedPrimitivesSignatureAccountId20;
      readonly proxyType: SeedRuntimeImplsProxyType;
    } & Struct;
    ...
    readonly type: 'Create' | 'RegisterDelegate' | 'UnregisterDelegate' | 'TransferFuturepass' | 'ProxyExtrinsic' | 'SetFuturepassMigrator' | 'MigrateEvmFuturepass';
  }

  /** @name PalletSchedulerError (330) */
  ...
  /** @name PalletUtilityError (331) */
  interface PalletUtilityError extends Enum {
    readonly isTooManyCalls: boolean;
    readonly type: 'TooManyCalls';
  }

  /** @name PalletRecoveryRecoveryConfig (332) */
  ...
  /** @name PalletRecoveryActiveRecovery (335) */
  ...
  /** @name PalletBalancesReleases (344) */
  ...
  /** @name PalletAssetsAssetDetails (346) */
  ...
  /** @name PalletAssetsAssetAccount (348) */
  ...
  /** @name PalletAssetsExistenceReason (349) */
  ...
  /** @name PalletAssetsApproval (351) */
  interface PalletAssetsApproval extends Struct {
    readonly amount: u128;
    readonly deposit: u128;
  }

  /** @name PalletAssetsAssetMetadata (352) */
  ...
  interface PalletAssetsExtError extends Enum {
    ...
    readonly type: 'NoAvailableIds' | 'BalanceLow' | 'NoAccount' | 'Overflow' | 'MaxHolds' | 'CreateAssetFailed';
  }
  ...
  /** @name PalletAuthorshipError (363) */
  ...
  /** @name PalletStakingStakingLedger (364) */
  ...
  /** @name PalletStakingUnlockChunk (366) */
  ...
  /** @name PalletStakingActiveEraInfo (370) */
  ...
  /** @name PalletStakingUnappliedSlash (377) */
  ...
  /** @name PalletStakingSlashingSlashingSpans (379) */
  ...
  /** @name PalletStakingSlashingSpanRecord (380) */
  interface PalletStakingSlashingSpanRecord extends Struct {
    readonly slashed: u128;
    readonly paidOut: u128;
  }

  /** @name PalletStakingReleases (383) */
  ...
  /** @name PalletStakingPalletError (384) */
  ...
  /** @name SpStakingOffenceOffenceDetails (385) */
  ...
  /** @name PalletImOnlineBoundedOpaqueNetworkState (399) */
  interface PalletImOnlineBoundedOpaqueNetworkState extends Struct {
    readonly peerId: Bytes;
    readonly externalAddresses: Vec<Bytes>;
  }

  /** @name PalletImOnlineError (403) */
  ...
  /** @name PalletTransactionPaymentReleases (406) */
  ...
  /** @name PalletDexTradingPairStatus (408) */
  ...
  interface PalletDexError extends Enum {
    ...
    readonly type: 'MustBeEnabled' | 'MustBeNotEnabled' | 'InsufficientInputAmount' | 'InvalidInputAmounts' | 'InsufficientAmount' | 'InsufficientAmountA' | 'InsufficientAmountB' | 'InsufficientLiquidityBurnt' | 'InsufficientWithdrawnAmountA' | 'InsufficientWithdrawnAmountB' | 'InsufficientOutputAmount' | 'InvalidLiquidityIncrement' | 'InvalidConstantProduct' | 'IdenticalTokenAddress' | 'InvalidAssetId' | 'InvalidTradingPathLength' | 'InsufficientTargetAmount' | 'ExcessiveSupplyAmount' | 'InsufficientLiquidity' | 'ZeroSupplyAmount' | 'ZeroTargetAmount' | 'UnacceptableShareIncrement' | 'LiquidityProviderTokenNotCreated';
  }

  /** @name PalletNftCollectionInformation (410) */
  ...
  /** @name PalletNftTokenOwnership (412) */
  interface PalletNftTokenOwnership extends Struct {
    readonly owner: SeedPrimitivesSignatureAccountId20;
    readonly ownedSerials: Vec<u32>;
  }

  /** @name PalletNftTokenLockReason (414) */
  interface PalletNftTokenLockReason extends Enum {
    readonly isListed: boolean;
    readonly asListed: u128;
    readonly type: 'Listed';
  }

  /** @name PalletNftMarketplace (415) */
  interface PalletNftMarketplace extends Struct {
    readonly account: SeedPrimitivesSignatureAccountId20;
    readonly entitlement: Permill;
  }

  /** @name PalletNftListing (416) */
  interface PalletNftListing extends Enum {
    readonly isFixedPrice: boolean;
    readonly asFixedPrice: PalletNftFixedPriceListing;
    readonly isAuction: boolean;
    readonly asAuction: PalletNftAuctionListing;
    readonly type: 'FixedPrice' | 'Auction';
  }

  /** @name PalletNftFixedPriceListing (417) */
  interface PalletNftFixedPriceListing extends Struct {
    readonly paymentAsset: u32;
    readonly fixedPrice: u128;
    readonly close: u32;
    readonly buyer: Option<SeedPrimitivesSignatureAccountId20>;
    ...
    readonly collectionId: u32;
    readonly serialNumbers: Vec<u32>;
    readonly royaltiesSchedule: PalletNftRoyaltiesSchedule;
    readonly marketplaceId: Option<u32>;
  }

  /** @name PalletNftAuctionListing (418) */
  interface PalletNftAuctionListing extends Struct {
    readonly paymentAsset: u32;
    readonly reservePrice: u128;
    readonly close: u32;
    readonly seller: SeedPrimitivesSignatureAccountId20;
  ...
  /** @name PalletNftOfferType (420) */
  interface PalletNftOfferType extends Enum {
    readonly isSimple: boolean;
    readonly asSimple: PalletNftSimpleOffer;
    readonly type: 'Simple';
  }

  /** @name PalletNftSimpleOffer (421) */
  interface PalletNftSimpleOffer extends Struct {
    readonly tokenId: ITuple<[u32, u32]>;
    readonly assetId: u32;
    readonly amount: u128;
    readonly buyer: SeedPrimitivesSignatureAccountId20;
  ...
  interface PalletNftError extends Enum {
    ...
    readonly type: 'CollectionNameInvalid' | 'NoAvailableIds' | 'NotTokenOwner' | 'NoToken' | 'NotForFixedPriceSale' | 'NotForAuction' | 'NotCollectionOwner' | 'TokenNotListed' | 'MaxOffersReached' | 'TokenLocked' | 'RoyaltiesInvalid' | 'BidTooLow' | 'MixedBundleSale' | 'MarketplaceNotRegistered' | 'NoCollectionFound' | 'InvalidMetadataPath' | 'InvalidOffer' | 'NotBuyer' | 'NotSeller' | 'IsTokenOwner' | 'ZeroOffer' | 'TokenLimitExceeded' | 'MintLimitExceeded' | 'TokenOnAuction' | 'InvalidMaxIssuance' | 'MaxIssuanceAlreadySet' | 'MaxIssuanceReached' | 'AttemptedMintOnBridgedToken' | 'CannotClaimNonClaimableCollections' | 'InitialIssuanceNotZero' | 'CollectionIssuanceNotZero';
  }

  /** @name PalletXrplBridgeHelpersXrpTransaction (428) */
  interface PalletXrplBridgeHelpersXrpTransaction extends Struct {
    readonly transactionHash: H512;
    readonly transaction: PalletXrplBridgeHelpersXrplTxData;
    readonly timestamp: u64;
  }

  /** @name PalletXrplBridgeHelpersXrplTicketSequenceParams (429) */
  interface PalletXrplBridgeHelpersXrplTicketSequenceParams extends Struct {
    readonly startSequence: u32;
    readonly bucketSize: u32;
  }

  /** @name PalletXrplBridgeError (430) */
  interface PalletXrplBridgeError extends Enum {
    ...
    readonly type: 'NotPermitted' | 'RelayerDoesNotExists' | 'WithdrawInvalidAmount' | 'DoorAddressNotSet' | 'TooManySigners' | 'InvalidSigners' | 'TxReplay' | 'NextTicketSequenceParamsNotSet' | 'NextTicketSequenceParamsInvalid' | 'TicketSequenceParamsInvalid' | 'CannotProcessMoreTransactionsAtThatBlock';
  }

  /** @name PalletTokenApprovalsError (433) */
  interface PalletTokenApprovalsError extends Enum {
    ...
    readonly type: 'NoToken' | 'NotTokenOwner' | 'NotTokenOwnerOrApproved' | 'CallerNotOperator' | 'ApprovedAmountTooLow' | 'CallerNotApproved' | 'AlreadyApproved' | 'ApprovalDoesntExist';
  }

  /** @name PalletEchoError (434) */
  ...
  /** @name PalletElectionProviderMultiPhasePhase (435) */
  ...
  /** @name PalletElectionProviderMultiPhaseReadySolution (437) */
  ...
  /** @name PalletElectionProviderMultiPhaseRoundSnapshot (438) */
  interface PalletElectionProviderMultiPhaseRoundSnapshot extends Struct {
    readonly voters: Vec<ITuple<[SeedPrimitivesSignatureAccountId20, u64, Vec<SeedPrimitivesSignatureAccountId20>]>>;
    readonly targets: Vec<SeedPrimitivesSignatureAccountId20>;
  }

  /** @name PalletElectionProviderMultiPhaseSignedSignedSubmission (445) */
  ...
  /** @name PalletElectionProviderMultiPhaseError (446) */
  ...
  /** @name PalletBagsListListNode (447) */
  ...
  /** @name PalletBagsListListListError (450) */
  ...
  /** @name PalletEthyEventClaimStatus (452) */
  ...
  /** @name PalletEthyCheckedEthCallRequest (456) */
  ...
  interface PalletEthyError extends Enum {
    ...
    readonly type: 'NoLocalSigningAccount' | 'OffchainUnsignedTxSignedPayload' | 'InvalidNotarization' | 'HttpFetch' | 'InvalidClaim' | 'OcwConfig' | 'EventReplayPending' | 'EventReplayProcessed' | 'BridgePaused' | 'Internal' | 'NoPermission' | 'NoClaim' | 'ClaimAlreadyChallenged' | 'CantUnbondRelayer' | 'CantBondRelayer' | 'NoBondPaid' | 'MaxNewSignersExceeded';
  }

  /** @name FpRpcTransactionStatus (460) */
  ...
  /** @name EthbloomBloom (463) */
  interface EthbloomBloom extends U8aFixed {}

  /** @name EthereumReceiptReceiptV3 (465) */
  ...
  /** @name EthereumReceiptEip658ReceiptData (466) */
  ...
  /** @name EthereumTypesHashH64 (469) */
  interface EthereumTypesHashH64 extends U8aFixed {}

  /** @name PalletEthereumError (474) */
  interface PalletEthereumError extends Enum {
    ...
    readonly type: 'InvalidSignature' | 'PreLogExists' | 'GasLimitTooLow' | 'GasLimitTooHigh' | 'GasPriceTooLow' | 'BalanceLow' | 'InvalidNonce' | 'Undefined';
  }

  /** @name PalletEvmError (476) */
  ...
  /** @name PalletErc20PegPendingPayment (479) */
  ...
  /** @name PalletErc20PegErc20DepositEvent (480) */
  ...
  /** @name PalletErc20PegWithdrawMessage (481) */
  ...
  interface PalletErc20PegError extends Enum {
    ...
    readonly isInvalidAbiEncoding: boolean;
    readonly type: 'CreateAssetFailed' | 'InvalidAmount' | 'InvalidPalletId' | 'DepositsPaused' | 'WithdrawalsPaused' | 'UnsupportedAsset' | 'EvmWithdrawalFailed' | 'InvalidAbiEncoding';
  }

  /** @name PalletNftPegError (483) */
  interface PalletNftPegError extends Enum {
    ...
    readonly type: 'ExceedsMaxAddresses' | 'ExceedsMaxTokens' | 'InvalidAbiEncoding' | 'InvalidAbiPrefix' | 'NoCollectionFound' | 'NoMappedTokenExists' | 'NoPermissionToBridge' | 'StateSyncDisabled' | 'TokenListLengthMismatch' | 'ExceedsMaxVecLength';
  }

  /** @name PalletFeeProxyError (484) */
  ...
  /** @name PalletFeeControlFeeConfig (485) */
  interface PalletFeeControlFeeConfig extends Struct {
    readonly evmBaseFeePerGas: U256;
    readonly weightMultiplier: Perbill;
    readonly lengthMultiplier: u128;
  }

  /** @name PalletXls20Error (486) */
  interface PalletXls20Error extends Enum {
    ...
    readonly isNoToken: boolean;
    readonly isNotCollectionOwner: boolean;
    readonly type: 'NotRelayer' | 'MappingAlreadyExists' | 'Xls20MintFeeTooLow' | 'NotXLS20Compatible' | 'NoToken' | 'NotCollectionOwner';
  }

  /** @name PalletProxyProxyDefinition (489) */
  ...
  /** @name PalletProxyAnnouncement (493) */
  ...
  /** @name PalletFuturepassError (496) */
  interface PalletFuturepassError extends Enum {
    ...
    readonly type: 'AccountAlreadyRegistered' | 'DelegateNotRegistered' | 'DelegateAlreadyExists' | 'NotFuturepassOwner' | 'OwnerCannotUnregister' | 'PermissionDenied' | 'MigratorNotSet';
  }

  /** @name SeedPrimitivesSignatureEthereumSignature (498) */
