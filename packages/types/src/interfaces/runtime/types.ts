...
import type { GenericAccountId33, GenericAccountIndex, GenericBlock, GenericCall, GenericConsensusEngineId, GenericLookupSource, GenericMultiAddress, StorageKey } from '@polkadot/types';
...
/** @name AccountId20 */
export interface AccountId20 extends EthereumAccountId {}

/** @name AccountId32 */
export interface AccountId32 extends EthereumAccountId {}
...
/** @name Lookup0 */
export interface Lookup0 extends AccountId {}
