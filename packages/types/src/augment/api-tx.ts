...
import type {
	...
	Percent,
	Permill,
} from "@therootnetwork/types/interfaces/runtime";
	...
	interface AugmentedSubmittables<ApiType extends ApiTypes> {
		...
		dex: {
			...
			addLiquidity: AugmentedSubmittable<
				(
					assetIdA: u32 | AnyNumber | Uint8Array,
					assetIdB: u32 | AnyNumber | Uint8Array,
					...
					minShareIncrement: Compact<u128> | AnyNumber | Uint8Array
				) => SubmittableExtrinsic<ApiType>,
				[u32, u32, Compact<u128>, Compact<u128>, Compact<u128>, Compact<u128>, Compact<u128>]
			>;
			/**
			...
			removeLiquidity: AugmentedSubmittable<
				(
					assetIdA: u32 | AnyNumber | Uint8Array,
					assetIdB: u32 | AnyNumber | Uint8Array,
					removeLiquidity: Compact<u128> | AnyNumber | Uint8Array,
					minWithdrawnA: Compact<u128> | AnyNumber | Uint8Array,
					minWithdrawnB: Compact<u128> | AnyNumber | Uint8Array
				) => SubmittableExtrinsic<ApiType>,
				[u32, u32, Compact<u128>, Compact<u128>, Compact<u128>]
			>;
			/**
			...
			swapWithExactSupply: AugmentedSubmittable<
				...
				[Compact<u128>, Compact<u128>, Vec<u32>]
			>;
			/**
		...
		futurepass: {
			...
			migrateEvmFuturepass: AugmentedSubmittable<
				...
				[SeedPrimitivesSignatureAccountId20, SeedPrimitivesSignatureAccountId20, Vec<u32>]
			>;
			/**
			 ...
			 * # </weight>
			 **/
			registerDelegate: AugmentedSubmittable<
				(
					futurepass: SeedPrimitivesSignatureAccountId20 | string | Uint8Array,
					delegate: SeedPrimitivesSignatureAccountId20 | string | Uint8Array,
					proxyType:
		...
		nft: {
			...
			createCollection: AugmentedSubmittable<
				(
					...
					royaltiesSchedule:
						| Option<PalletNftRoyaltiesSchedule>
						| null
						| Uint8Array
						| PalletNftRoyaltiesSchedule
						| { entitlements?: any }
