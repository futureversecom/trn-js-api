...
declare module "@polkadot/api-base/types/storage" {
	interface AugmentedQueries<ApiType extends ApiTypes> {
		...
		ethBridge: {
			 ...
			 */
			bridgePaused: AugmentedQuery<ApiType, () => Observable<bool>, []>;
			/**
		...
		feeControl: {
			data: AugmentedQuery<ApiType, () => Observable<PalletFeeControlFeeConfig>, []>;
		};
		futurepass: {
			/**
			 ...
			 */
			migrationAdmin: AugmentedQuery<ApiType, () => Observable<Option<U8aFixed>>, []>;
			/**
		...
		xrplBridge: {
			...
			processXRPTransactionDetails: AugmentedQuery<
				...
				(
					...
					Option<
						ITuple<[u64, PalletXrplBridgeHelpersXrpTransaction, SeedPrimitivesSignatureAccountId20]>
					>
				>,
				[H512]
			>;
