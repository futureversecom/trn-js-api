...
declare module "@polkadot/api-base/types/storage" {
	interface AugmentedQueries<ApiType extends ApiTypes> {
		...
		assetsExt: {
			 ...
			 */
			nextAssetId:
				& AugmentedQuery<ApiType, () => Observable<u32>, []>
		...
		authorship: {
			 ...
			 */
			author:
				& AugmentedQuery<ApiType, () => Observable<Option<U8aFixed>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * Whether uncles were already set in this block.
			 */
			didSetUncles:
				& AugmentedQuery<ApiType, () => Observable<bool>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * Uncles
			 */
			uncles:
				& AugmentedQuery<ApiType, () => Observable<Vec<PalletAuthorshipUncleEntryItem>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * Generic query
			 */
		...
		babe: {
			 ...
			 */
			currentSlot:
				& AugmentedQuery<ApiType, () => Observable<u64>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			epochStart:
				& AugmentedQuery<ApiType, () => Observable<ITuple<[u32, u32]>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			nextRandomness:
				& AugmentedQuery<ApiType, () => Observable<U8aFixed>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
		...
		balances: {
			 ...
			 */
			storageVersion:
				& AugmentedQuery<ApiType, () => Observable<PalletBalancesReleases>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * The total units issued in the system.
			 */
			totalIssuance:
				& AugmentedQuery<ApiType, () => Observable<u128>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * Generic query
			 */
		...
		dex: {
			 ...
			 */
			feeTo:
				& AugmentedQuery<ApiType, () => Observable<Option<SeedPrimitivesSignatureAccountId20>>, []>
				& QueryableStorageEntry<ApiType, []>;
			liquidityPool:
				& AugmentedQuery<
					ApiType,
			...
			liquidityPoolLastK:
				& AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<U256>, [u32]>
				& QueryableStorageEntry<ApiType, [u32]>;
			tradingPairLPToken:
				& AugmentedQuery<
					ApiType,
		...
		electionProviderMultiPhase: {
			 ...
			 */
			currentPhase:
				& AugmentedQuery<ApiType, () => Observable<PalletElectionProviderMultiPhasePhase>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			desiredTargets:
				& AugmentedQuery<ApiType, () => Observable<Option<u32>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			...
			minimumUntrustedScore:
				& AugmentedQuery<ApiType, () => Observable<Option<SpNposElectionsElectionScore>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			...
			signedSubmissionIndices:
				& AugmentedQuery<ApiType, () => Observable<BTreeMap<SpNposElectionsElectionScore, u32>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
		...
		erc20Peg: {
			 ...
			 */
			contractAddress:
				& AugmentedQuery<ApiType, () => Observable<H160>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			readyBlocks:
				& AugmentedQuery<ApiType, () => Observable<Vec<u32>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
		...
		ethBridge: {
			...
			delayedEventProofsPerBlock:
				& AugmentedQuery<ApiType, () => Observable<u8>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			...
			ethCallRequestInfo:
				& AugmentedQuery<
					...
					(
						arg: u64 | AnyNumber | Uint8Array,
					) => Observable<Option<PalletEthyCheckedEthCallRequest>>,
					[u64]
				>
				& QueryableStorageEntry<ApiType, [u64]>;
			/**
			 ...
			 */
			ethCallRequests:
				& AugmentedQuery<ApiType, () => Observable<Vec<u64>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
		...
		ethereum: {
			blockHash:
				& AugmentedQuery<ApiType, (arg: U256 | AnyNumber | Uint8Array) => Observable<H256>, [U256]>
				& QueryableStorageEntry<ApiType, [U256]>;
			/**
			 * The current Ethereum block.
			 */
			currentBlock:
				& AugmentedQuery<ApiType, () => Observable<Option<EthereumBlock>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * The current Ethereum receipts.
			 */
			currentReceipts:
				& AugmentedQuery<ApiType, () => Observable<Option<Vec<EthereumReceiptReceiptV3>>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * The current transaction statuses.
			 */
			currentTransactionStatuses:
				& AugmentedQuery<ApiType, () => Observable<Option<Vec<FpRpcTransactionStatus>>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
		...
		evm: {
			accountCodes:
				& AugmentedQuery<ApiType, (arg: H160 | string | Uint8Array) => Observable<Bytes>, [H160]>
				& QueryableStorageEntry<ApiType, [H160]>;
			accountStorages:
				& AugmentedQuery<
					ApiType,
		...
		feeControl: {
			data:
				& AugmentedQuery<ApiType, () => Observable<PalletFeeControlFeeConfig>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * Generic query
			 */
		...
		grandpa: {
			 ...
			 */
			pendingChange:
				& AugmentedQuery<ApiType, () => Observable<Option<PalletGrandpaStoredPendingChange>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			stalled:
				& AugmentedQuery<ApiType, () => Observable<Option<ITuple<[u32, u32]>>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * State of the current authority set.
			 */
			state:
				& AugmentedQuery<ApiType, () => Observable<PalletGrandpaStoredState>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * Generic query
			 */
		...
		imOnline: {
			 ...
			 */
			keys:
				& AugmentedQuery<ApiType, () => Observable<Vec<PalletImOnlineSr25519AppSr25519Public>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
		...
		nft: {
			...
			listings:
				& AugmentedQuery<
					ApiType,
					(arg: u128 | AnyNumber | Uint8Array) => Observable<Option<PalletNftListing>>,
					[u128]
				>
			...
			offers:
				& AugmentedQuery<
					ApiType,
					(arg: u64 | AnyNumber | Uint8Array) => Observable<Option<PalletNftOfferType>>,
					[u64]
				>
				& QueryableStorageEntry<ApiType, [u64]>;
			/**
			...
			registeredMarketplaces:
				& AugmentedQuery<
					ApiType,
					(arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PalletNftMarketplace>>,
					[u32]
				>
				& QueryableStorageEntry<ApiType, [u32]>;
			/**
			...
			tokenLocks:
				& AugmentedQuery<
					...
					) => Observable<Option<PalletNftTokenLockReason>>,
					[ITuple<[u32, u32]>]
				>
		...
		session: {
			...
			keyOwner:
				& AugmentedQuery<
					ApiType,
					(
						arg: ITuple<[SpCoreCryptoKeyTypeId, Bytes]> | [
			...
			queuedKeys:
				& AugmentedQuery<
					ApiType,
					() => Observable<
						Vec<ITuple<[SeedPrimitivesSignatureAccountId20, SeedRuntimeSessionKeys]>>
					>,
					[]
				>
				& QueryableStorageEntry<ApiType, []>;
			 ...
			 */
			validators:
				& AugmentedQuery<ApiType, () => Observable<Vec<SeedPrimitivesSignatureAccountId20>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * Generic query
			 */
		...
		staking: {
			 ...
			 */
			activeEra:
				& AugmentedQuery<ApiType, () => Observable<Option<PalletStakingActiveEraInfo>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			bondedEras:
				& AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, u32]>>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			chillThreshold:
				& AugmentedQuery<ApiType, () => Observable<Option<Percent>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			erasTotalStake:
				& AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<u128>, [u32]>
				& QueryableStorageEntry<ApiType, [u32]>;
			/**
			 ...
			 */
			forceEra:
				& AugmentedQuery<ApiType, () => Observable<PalletStakingForcing>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			minCommission:
				& AugmentedQuery<ApiType, () => Observable<Perbill>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			offendingValidators:
				& AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[u32, bool]>>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			...
			spanSlash:
				& AugmentedQuery<
					ApiType,
					(
						arg: ITuple<[SeedPrimitivesSignatureAccountId20, u32]> | [
			 ...
			 */
			storageVersion:
				& AugmentedQuery<ApiType, () => Observable<PalletStakingReleases>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
		...
		system: {
			 ...
			 */
			blockHash:
				& AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<H256>, [u32]>
				& QueryableStorageEntry<ApiType, [u32]>;
			/**
			 * The current weight for the block.
			 */
			blockWeight:
				& AugmentedQuery<ApiType, () => Observable<FrameSupportWeightsPerDispatchClassU64>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * Digest of the current block, also part of the block header.
			 */
			digest:
				& AugmentedQuery<ApiType, () => Observable<SpRuntimeDigest>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			events:
				& AugmentedQuery<ApiType, () => Observable<Vec<FrameSystemEventRecord>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			executionPhase:
				& AugmentedQuery<ApiType, () => Observable<Option<FrameSystemPhase>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			extrinsicData:
				& AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Bytes>, [u32]>
				& QueryableStorageEntry<ApiType, [u32]>;
			/**
			 * Stores the `spec_version` and `spec_name` of when the last runtime upgrade happened.
			 */
			lastRuntimeUpgrade:
				& AugmentedQuery<ApiType, () => Observable<Option<FrameSystemLastRuntimeUpgradeInfo>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 ...
			 */
			parentHash:
				& AugmentedQuery<ApiType, () => Observable<H256>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
		...
		tokenApprovals: {
			erc1155ApprovalsForAll:
				& AugmentedQuery<
					...
					(
						arg1: SeedPrimitivesSignatureAccountId20 | string | Uint8Array,
						arg2: ITuple<[u32, SeedPrimitivesSignatureAccountId20]> | [
							u32 | AnyNumber | Uint8Array,
							SeedPrimitivesSignatureAccountId20 | string | Uint8Array,
						],
					) => Observable<Option<bool>>,
			...
			erc20Approvals:
				& AugmentedQuery<
					ApiType,
					(
						arg1: ITuple<[SeedPrimitivesSignatureAccountId20, u32]> | [
							SeedPrimitivesSignatureAccountId20 | string | Uint8Array,
							u32 | AnyNumber | Uint8Array,
						],
						arg2: SeedPrimitivesSignatureAccountId20 | string | Uint8Array,
		...
		transactionPayment: {
			nextFeeMultiplier:
				...
				& QueryableStorageEntry<ApiType, []>;
			storageVersion:
				& AugmentedQuery<ApiType, () => Observable<PalletTransactionPaymentReleases>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			 * Generic query
			 */
		...
		xrplBridge: {
			 ...
			 */
			doorAddress:
				& AugmentedQuery<ApiType, () => Observable<Option<H160>>, []>
				& QueryableStorageEntry<ApiType, []>;
			/**
			...
			doorTicketSequenceParams:
				& AugmentedQuery<
					ApiType,
					() => Observable<PalletXrplBridgeHelpersXrplTicketSequenceParams>,
					[]
				>
				& QueryableStorageEntry<ApiType, []>;
			/**
			...
			processXRPTransactionDetails:
				& AugmentedQuery<
					...
					(
						...
						Option<
							ITuple<
								[u64, PalletXrplBridgeHelpersXrpTransaction, SeedPrimitivesSignatureAccountId20]
							>
						>
					>,
					[H512]
